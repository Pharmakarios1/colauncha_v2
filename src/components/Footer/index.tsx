      ...
      <div className="grid md:grid-cols-[3fr_1fr]">
        ...
        <div className="flex flex-col items-center justify-center ">
          <div
            ...
            className="absolute top-0 right-5 transform -translate-y-4 w-12 h-12 rounded-full cursor-pointer bg-blue-900 flex items-center justify-center "
          >
            <div className="animate-pulse"></div>
            <ArrowUpOutlined className="!text-white !font-bold" />
          </div>
          <p className="text-sm">
            {' '}
