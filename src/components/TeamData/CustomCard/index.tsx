...
const CustomCard: React.FC<TeamMemberProps> = ({teamImg ,...props}) => {
  return (
    <div>
        <div className="flex   md:flex-col md:items-center  w-full max-w-sm md:max-w-[300px] bg-white rounded-lg shadow-md p-6">
            <img src={teamImg} alt="Team Member" className="w-44 h-44 rounded-md" />
