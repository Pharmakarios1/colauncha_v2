...
const OurTeam = () => {
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100  px-2 lg:px-12 pt-10">
      <div className="">
      ...
      <div className=" relative flex items-center bg-white gap-4 w-full h-full p-2 rounded-md md:max-w-[600px] my-10 shadow-2xl">
        ...
        <div className="absolute  bottom-10 text-[12px] left-44 bg-[#D9D9D942] text-white rounded-md p-1">CEO & Founder</div>
      </div>
      <Team />
    </div>
  );
